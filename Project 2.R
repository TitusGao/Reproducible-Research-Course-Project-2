setwd("E:/Coursera/R_programming_course/Reproducible Research/Week 4/Reproducible Research Course Project 2")
...
if(!file.exists(paste0('data/', filename)) ){
    download.file(fileUrl, paste0('data/', filename), method = 'curl')
}


## ----cache=TRUE----------------------------------------------------------
storm <- read.csv(bzfile("data/repdata_data_StormData.csv.bz2"))
